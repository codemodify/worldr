...
**Status:** 0.9.36-dev. Mesh wobble on title-drag + burn on close (`--effects=high`); **Ctrl+Q** quits.
...
foot
# title-drag = jelly mesh; SSD × or quit the client = burn dissolve (--effects=high)
